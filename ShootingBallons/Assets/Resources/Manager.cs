...
public class Manager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        positions[1] = new Vector3(2f, 0f, 0.0f);
        positions[2] = new Vector3(2.0f, -2.0f, 0.0f);
        positions[3] = new Vector3(0f, -2.0f, 0.0f);
        positions[4] = new Vector3(-2f, 0f, 0.0f);
        //positions[4] = new Vector3(-2f, -4.0f, 0.0f);
        //positions[4] = new Vector3(-2f, -6.0f, 0.0f);
        lineRenderer.positionCount = 5;  //set the number of vertices this line have, including two end of the line
        lineRenderer.numCornerVertices = 5;  //higher value will smooth the corner
        lineRenderer.numCapVertices = 3;  //higher value will smooth the two end of the line
        lineRenderer.SetPositions(positions);  //in this case, a "^" shape line
